...
class TestLogin(unittest.TestCase):
    ...
    def test_login(self):
        ...
        self.assertTrue(url.endswith('/dashboard'), msg="Failed to redirect to the dashboard")
        self.assertTrue(dashboard_page.get_banner().endswith('test'), msg="User not logged in")
